      ...
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <h1 className="text-6xl font-display font-bold leading-tight text-white">
            Unlock the <br /> 
            <span className="text-accent italic">Universe</span> <br />
            of Knowledge
          </h1>
          <p className="text-slate-400 text-xl max-w-md leading-relaxed">
            Every book is a new world. Sign in to continue your journey through the cosmos of literature.
          </p>
          <div className="space-y-6">
            {[
              { icon: ShieldCheck, text: "Secure 256-bit SSL encryption" },
              { icon: Chrome, text: "One-tap Google login" },
              ...
              >
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-accent text-sm font-bold uppercase tracking-[0.2em]">Open to Enter</p>
                  </div>
                  <div className="pt-12">
                    <motion.div
                      animate={{ x: [0, 10, 0] }}
